...
/**From Cookbook formulae for audio EQ biquad filter coefficients by Robert Bristow-Johnson.
  * Notes say, constant 0 dB peak gain. I continue to really love that document
  *
  * @param sampleRate sample rate
  * @param freq the frequency
  * @param q Q.
  */
class BandPassBiQuadConstZeroGainFilter(val sampleRate: Int, override var freq: Float, var q: Float)
